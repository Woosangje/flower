...
public class ItemController {
    ...
    public String product(@RequestParam(name = "pname",required = false) String pname, @RequestParam(name = "pcate",required = false) String pcate, Optional<Integer> page, Model model) {
        ...
        Pageable pageable = PageRequest.of(page.isPresent() ? (Integer)page.get() : 0, 12);
